...
export default function Dashboard() {
  ...
  const stats = [
    { label: 'Total Content', value: recentContent.length, icon: PenTool, color: 'bg-blue-500' },
    { label: 'Scheduled', value: 0, icon: Calendar, color: 'bg-purple-500' },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="p-6 border-b border-gray-50 flex justify-between items-center">
            ...
            <Link to="/calendar" className="text-blue-600 text-sm font-medium hover:underline">View All</Link>
          </div>
          <div className="divide-y divide-gray-50">
            {loading ? (
              ...
              <div className="p-12 text-center">
                ...
                <Link to="/generate" className="text-blue-600 font-medium mt-2 inline-block">Start creating</Link>
              </div>
            ) : (
        ...
        <div className="bg-blue-600 rounded-3xl p-8 text-white shadow-xl shadow-blue-200 relative overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="text-blue-100 text-sm mb-6">Based on your brand profile, here's what you should post next.</p>
